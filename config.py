...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--model_name", default="FEMEAT", type=str, choices=["EVA", "MCLEA", "MSNEA", "FEMEAT"], help="model name")
        ...
        parser.add_argument("--ocr_dim", type=int, default=100, help="the hidden size of ocr feature")
        ...
        parser.add_argument("--w_ocr", action="store_false", default=True, help="with ocr features")
        ...
        # --------- FEMEAT -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of FEMEAT")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of FEMEAT")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of FEMEAT")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of FEMEAT")
